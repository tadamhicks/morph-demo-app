...
node {
    ...
    stage('Provision Prod App') {
        ...
        withCredentials([string(credentialsId: 'demo-morph-scrt', variable: 'bearer')]) {
            ...
            Map<?, ?> postBody = [ "image": "https://demo.morpheusdata.com/storage/logos/uploads/AppTemplate/69/templateImage/Screen Shot 2017-11-21 at 7.52.28 PM_original.png", "tiers": [  "App": [   "linkedTiers": [    "Cache",    "Database"   ],   "tier": [    "bootOrder": 1,    "lockedFields": [     "bootOrder"    ]   ],   "instances": [    [     "instance": [      "type": "wapp",      "cloud": "AWS Cali",      "layout": [       "code": "03574fc2-00b5-455c-919d-550230a1de96",       "id": 923      ],      "expireDays": "2",      "name": "${userInitials}-demo-${cloudCode}-${type}-${sequence}",      "allowExisting": true,      "shutdownDays": "1"     ],     "backup": [      "createBackup": true     ],     "loadBalancer": [      [       "vipShared": "off",       "externalAddress": "off",       "id": 9,       "externalPort": 9090,       "enabled": true,       "externalAddressCheck": false,       "protocol": "http",       "balanceMode": "leastconnections",       "vipPort": 9090,       "internalPort": 9090      ]     ],     "layoutSize": 3,     "volumes": [      [       "size": 3,       "name": "root",       "rootVolume": true      ]     ],     "plan": [      "code": "container-256",      "id": 69     ],     "metadata": [      [       "name": "",       "value": ""      ]     ],     "evars": [      [       "name": "",       "value": ""      ]     ]    ]   ]  ],  "Database": [   "linkedTiers": [],   "instances": [    [     "instance": [      "type": "mysql",      "cloud": "AWS Cali",      "layout": [       "code": "mysql-amazon-5.6-master-slave",       "id": 440      ],      "expireDays": "2",      "name": "${userInitials}-demo-${cloudCode}-${type}-${sequence}",      "allowExisting": true,      "shutdownDays": "1",      "userGroup": [       "id": ""      ],      "usingExisting": true,      "existingInstanceId": 2484     ],     "backup": [      "createBackup": true     ],     "networkInterfaces": [      [       "primaryInterface": true,       "network": [        "id": ""       ]      ]     ],     "volumes": [      [       "vId": 508413,       "size": 1,       "maxIOPS": null,       "name": "root",       "rootVolume": true,       "storageType": 6      ]     ],     "plan": [      "code": "amazon-t2.small",      "id": 3     ],     "config": [      "publicIpType": "subnet"     ],     "metadata": [      [       "name": "",       "value": ""      ]     ],     "evars": [      [       "name": "",       "value": ""      ]     ]    ]   ]  ],  "Cache": [   "linkedTiers": [],   "instances": [    [     "instance": [      "type": "redis",      "cloud": "AWS Cali",      "layout": [       "code": "redis-3.2-single",       "id": 666      ],      "expireDays": "2",      "name": "${userInitials}-demo-${cloudCode}-${type}-${sequence}",      "allowExisting": true,      "shutdownDays": "1"     ],     "backup": [      "createBackup": true     ],     "volumes": [      [       "size": 3,       "name": "root",       "rootVolume": true      ]     ],     "plan": [      "code": "container-256",      "id": 69     ],     "metadata": [      [       "name": "",       "value": ""      ]     ],     "evars": [      [       "name": "",       "value": ""      ]     ]    ]   ]  ] ], "name": "fff", "description": "Production version using existing instances to promote", "templateImage": "", "id": 69, "templateName": "A_D_A-prod", "group": [  "id": 2,  "name": "All Clouds Demo" ], "environment": "Production"]
